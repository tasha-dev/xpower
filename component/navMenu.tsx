...
export default function NavMenu({closeFn, isOpened, items}:NavMenuType):ReactNode {
    // Returning JSX
    return (
        <div data-opened={isOpened} className={'lg:hidden block fixed top-0 left-0 w-full h-full data-[opened="true"]:pointer-events-auto data-[opened="true"]:visible data-[opened="false"]:pointer-events-none data-[opened="false"]:invisible'}>
